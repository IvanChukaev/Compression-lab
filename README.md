...
| Сжатая и дообученная Qwen3-8B-4bit final | 5,71 гб | 0.658 |

Сжатая и дообученная Qwen3-8B-4bit final (Дообучение на большем количестве данных, тест на MLLU, 20 вопросов на каждый топик) - точность: 0.692

Точность оригинальной модели на MLLU, 20 вопросов на каждый топик: 0.706
